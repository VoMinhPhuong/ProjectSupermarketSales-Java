...
public class frmOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblOrderDetail4.setSelectionBackground(new java.awt.Color(27, 169, 255));
        ...
        btnPaySuccess.setBackground(new java.awt.Color(52, 117, 245));
        btnPaySuccess.setForeground(new java.awt.Color(255, 255, 255));
        btnPaySuccess.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-ok-24.png"))); // NOI18N
        btnPaySuccess.setText("Hoàn tất thanh toán");
        btnPaySuccess.setToolTipText("Lưu hóa đơn");
        btnPaySuccess.setBorderPainted(false);
        ...
        btnPrintOrder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-purchase-order-24.png"))); // NOI18N
        btnPrintOrder.setText("In hóa đơn");
        btnPrintOrder.setToolTipText("In hóa đơn gửi cho khách hàng kiểm tra");
        btnPrintOrder.setBorderPainted(false);

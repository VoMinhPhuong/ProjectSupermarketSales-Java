...
public class frmManageItem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnItemInfor.setBackground(new java.awt.Color(226, 254, 254));
                ...
                .addGroup(pnItemInforLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnItemInforLayout.createSequentialGroup()
                        ...
                        .addGroup(pnItemInforLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cboItemUnit, 0, 481, Short.MAX_VALUE)
                            .addComponent(cboProductType, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(92, 92, 92)
                .addGroup(pnItemInforLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnAdd, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
        ...
        pnItemInforLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnItemInforLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnItemInforLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnItemInforLayout.createSequentialGroup()
        ...
        tblProductList.setBackground(new java.awt.Color(234, 243, 244));
        ...
        tblProductList.setSelectionBackground(new java.awt.Color(27, 169, 255));
        ...
        btnOpenFrmItemType.setBackground(new java.awt.Color(5, 154, 3));
        btnOpenFrmItemType.setForeground(new java.awt.Color(255, 255, 255));
        btnOpenFrmItemType.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-add-new-24.png"))); // NOI18N
        btnOpenFrmItemType.setText("Loại mặt hàng");
        btnOpenFrmItemType.setToolTipText("Chọn để thêm loại mặt hàng");
        btnOpenFrmItemType.setBorderPainted(false);
        ...
        txtSales.setText("QUẢN LÝ MẶT HÀNG");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnItemInfor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        try {
            ...
            for (Product prod : getProducts()) {
                if (productName.equals(prod.getName()) && productTypeName.equals(prod.getType().getName())) {
                    JOptionPane.showMessageDialog(this, "Sản phẩm này đã tồn tại. Bạn có thể thực hiện chức năng sửa số lượng sản phẩm!", "Thông báo", JOptionPane.WARNING_MESSAGE);
                    clearInputs();
                    return;
                }
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selected < 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn mặt hàng cần xóa!", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
